  ...
  return (
    <footer className='flexCenter mb-24'>
      <div className='padding-container max-container  flex w-full flex-col gap-14'>
        ...
        <p className='regular-14 w-full text-center text-gray-30'>2024 Travel Diaries | All rights reserved</p>
        <p className='regular-14 w-full text-center text-gray-30'>Built by Demaestro Tech Solutions</p>
      </div>
    </footer>
  )
}
